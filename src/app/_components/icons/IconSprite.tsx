export default function IconSprite() {
  return (
    <svg style={{ display: "none" }}>
      <defs>
        <symbol id="icon-chart-bar" viewBox="0 0 24 24" fill="none" stroke="currentColor">
          <path
            strokeLinecap="round"
        ...
        <symbol id="icon-google-ads" viewBox="0 0 20 20" fill="currentColor">
          <path
            fillRule="evenodd"
        ...
        <symbol id="icon-spinner" viewBox="0 0 24 24" fill="none" stroke="currentColor">
          <circle
            cx="12"
            cy="12"
            r="10"
