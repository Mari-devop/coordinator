    ...
    return (
        <section className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-[var(--fontColor)] font-[var(--font-wix-madefor-display)] flex items-center">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex justify-end space-x-3 pt-4">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="px-4 py-2 text-sm font-medium text-white bg-[var(--secondaryBackground)] rounded-md hover:bg-[var(--accentColor)] focus:outline-none focus:ring-2 focus:ring-[var(--accentColor)] focus:ring-offset-2 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
